...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0,score1):
        ...
        if gain>previous_high:
            print(f"{gain} point(s)! That's the biggest gain yet for Player "+str(who))
            previous_high=gain
...
def max_scoring_num_rolls(dice=six_sided, num_samples=10):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    best_avg,curr_avg=0,0
    best_num=0
    for num_rolls in range(1,11):
        for i in range(num_samples):
            curr_avg=make_averaged(roll_dice,num_samples)(num_rolls,dice)
